...
CSV_RESULT_FILES = ['metrics_model_temporal_module.csv',  'metrics_model_spatial_module_conv.csv',
                    'metrics_model_combine_module_conv.csv',
                    'metrics_nwp_temporal_module.csv',  'metrics_nwp_spatial_module_conv.csv',
