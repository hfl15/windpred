"""
    copy from https://github.com/danielegrattarola/spektral/blob/master/spektral/layers/convolutional/graph_conv.py
"""
...
from .gcn_spektral_utils import filter_dot, dot, localpooling_filter
